  ...
  return (
    <div>
        {commentListData.map((item,index)=>(
            <div className='flex p-3 items-center border rounded-lg m-2'>
               ...
               <PopoverContent><Button className='w-full flex gap-2' variant='outline' onClick={()=>onDeleteComment(item)}><Trash2Icon/>Delete</Button></PopoverContent>
             </Popover>
